...
#Serial: Usado para mandar sinal pro arduino
import serial
...
def ML():
    ...
    while teste:
        ...
        #Criando coneção com a porta "COM3", Defina a porta e a velocidade
        #-> da sua coneção com seu arduino
